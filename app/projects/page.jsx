...
// images
import mths1 from "@/public/image/projects/web/mths/mths-1.png";
import mths2 from "@/public/image/projects/web/mths/mths-2.png";
import mths3 from "@/public/image/projects/web/mths/mths-3.png";
			...
			<main className="overflow-hidden">
				...
				<div className="mt-10 flex flex-col justify-start items-center w-full pl-10 md:pl-32">
					<div className="flex justify-center items-center flex-col my-5 self-start ">
						<Hr variant="long"></Hr>
						<h1 className="text-3xl font-bold mt-3">Highlighted Project</h1>
					</div>
				</div>
				<div className="relative w-screen mx-auto container gap-4 px-10 grid grid-cols-1 md:grid-cols-2 mb-10">
						...
						<div className="images relative w-full  aspect-square">
							<div className="absolute top-28 left-10 h-[40%]  aspect-video grayscale hover:grayscale-0 transition-all ease duration-300 hover:scale-150 z-10">
								<motion.div
									...
									<Image
										src={mths1}
										alt="Mount Tabor Historical Society page"
										layout="fill"
										objectFit="cover"
										placeholder="blur"
										className="rat"
							...
							<div className="absolute bottom-10 md:bottom-26 right-20 h-[35%]  aspect-video grayscale hover:grayscale-0 transition-all ease duration-300 hover:scale-150">
								<motion.div
									...
									<Image
										src={mths2}
										alt="Mount Tabor Historical Society webpage"
										layout="fill"
										objectFit="cover"
										placeholder="blur"
									/>
					...
					<motion.div
						...
						<p className="text-gray-600 text-justify title text-lg">
							The Mount Tabor Historical Society needed a modern, easy-to-navigate website that could showcase local history while supporting events, newsletters, tours, and volunteers. I rebuilt the entire site structure in WordPress using Elementor, reorganizing content, modernizing the layout, and creating a more intuitive user experience. A major feature is the fully interactive Walking Tour system powered by GeoDirectory, which supports both in-person and virtual visitors through unique stop pages, media galleries, and QR code signage located throughout the town.
						</p>{" "}
						<div className="mt-3">
							...
							<Button variation="secondary">
								<a
									href="https://wordpress-1459832-5615100.cloudwaysapps.com/"
									target="_blank"
